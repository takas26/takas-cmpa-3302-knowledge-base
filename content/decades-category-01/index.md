---
Decades: "Category 01: Will list and separate each cartoon by the decade it was released."
---
...
A similar category is [[networks-category-02/index| Category 02]], which also uses the `index.md` method to specify a category page title and descriptive text.